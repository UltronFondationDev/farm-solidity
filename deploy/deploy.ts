...
task('set-pool', "Changing pool's alloc point")
    .setAction(async (taskArgs, {ethers}) => {
        ...
        // await masterChef.set(0,  166, { gasLimit: 2000000 });
        // await masterChef.set(1,  83, { gasLimit: 2000000 });
        // await masterChef.set(2,  2, { gasLimit: 2000000 });
        // await masterChef.set(3,  37, { gasLimit: 2000000 });
        // await masterChef.set(4,  154, { gasLimit: 2000000 });
        // await masterChef.set(5,  2040, { gasLimit: 2000000 });
        // await masterChef.set(8,  18, { gasLimit: 2000000 });
